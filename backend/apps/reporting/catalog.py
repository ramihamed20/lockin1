...
REPORTS = {
    ...
    for item in (
        ...
        ReportDefinition(
            ...
            columns=("id", "status", "amount_minor", "currency", "refunded_amount_minor", "account__primary_user__email", "created_at", "succeeded_at"),
        ...
        ReportDefinition(
            ...
            columns=("id", "status", "plan_version__plan__code", "account__primary_user__email", "started_at", "current_period_ends_at", "cancel_at_period_end", "created_at"),
            filter_names=frozenset({"status", "from", "to"}),
            schedule_ready=True,
        ),
        ReportDefinition(
            ...
            capability=Capability.ANALYTICS_VIEW,
            columns=("id", "user__email", "context_type", "status", "started_at", "ended_at", "active_duration_seconds"),
            filter_names=frozenset({"from", "to"}),
            schedule_ready=True,
        ),
        ReportDefinition(
            ...
            columns=("id", "user__email", "status", "created_at", "completed_at", "quiz_version__quiz__id"),
        ...
        ReportDefinition(
            ...
            columns=("id", "actor__email", "action", "domain", "target_type", "target_id", "reason", "occurred_at"),
